...
<script>
  ...
  export default {
    ...
    mounted() {
      setTimeout(()=>{
        this.userid = this.userContent.UserId;
        this.username = this.userContent.UserName;
        this.password = this.userContent.PassWorld;
        this.age = this.userContent.Age;
        this.gender = this.userContent.Gender;
        this.birthday = this.userContent.Birthday;
        this.hometown = this.userContent.Hometown;
        this.phone = this.userContent.Phone;
        this.qq = this.userContent.QQ;
        this.picture = this.userContent.Picture;
      },500)
    }
  }
</script>
